...
public interface IFixedOrbit  {
    ...
    /// <param name="v">Velocity in physics space (x, y, z). OUTPUT by the method </param>
    /// <param name="isQuery">Request is a query and should not change state or do callbacks</param>

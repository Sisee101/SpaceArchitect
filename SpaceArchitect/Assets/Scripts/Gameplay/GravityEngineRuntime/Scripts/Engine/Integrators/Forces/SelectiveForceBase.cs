...
public abstract class SelectiveForceBase : MonoBehaviour, IForceDelegate {
    ...
    public abstract double[] CalcAccelerationIJPerM(double[] rji, int i, int j, GravityState.NbodyState[] nbodyStates);

    public abstract double[] CalcAccelerationIPerParticle(double[] rji, int i, GravityState.NbodyState[] nbodyStates);


    public abstract double[] CalcJerkIJPerM(double[] rji, int i, int j, GravityState.NbodyState[] nbodyStates);

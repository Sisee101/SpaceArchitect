...
using GravityEngineSolarSystem;
...
public class SolarBody : MonoBehaviour  {
    ...
    /// (Deprecated. Use the OrbitEllipse version after 4.1)
	/// </summary>
    ...
    /// <param name="epoch">Epoch.</param>
    /// <param name="ellipseBase">Ellipse base.</param>
    public void SetEllipseForEpoch(float epoch, OrbitUniversal orbitU) {

        switch (bodyType) {
            case SolarSystem.Type.PLANET:
                PlanetData.SetOrbit(epoch, orbitU, this);
                break;
            case SolarSystem.Type.ASTEROID:
                AsteroidData.SetOrbit(epoch, orbitU, this);
                break;
            case SolarSystem.Type.COMET:
                CometData.SetOrbit(epoch, orbitU, this);
                break;

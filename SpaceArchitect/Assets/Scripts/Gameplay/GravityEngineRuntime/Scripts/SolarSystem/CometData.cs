...
//  1P/Halley                                  49400  0.58597811 0.96714291 162.26269 111.33249  58.42008 19860205.89532 JPL J863/77
		...
		try {
			...
			float q = float.Parse(data[1], CultureInfo.InvariantCulture);
...
//			 " phase=" + ellipseBase.phase);
    ...
    public static void SetOrbit(float epoch, OrbitUniversal orbitU, SolarBody sb) {
        ...
        // epoch was for time at perihelion (i.e. longitude = 0)
        // w = w_bar - Omega, 
        orbitU.phase = OrbitEllipse.MeanToTrueAnomoly(NUtils.DegreesMod360(360f * numPeriod), (float) orbitU.eccentricity);
        //		Debug.Log(" numP=" + numPeriod + " M=" + NUtils.DegressMod360(360f*numPeriod) +
        //			 " phase=" + ellipseBase.phase);
    }

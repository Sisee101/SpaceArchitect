namespace SGP4
{
    ...
    public class SGP4utils
    {
         ...
         */
        public static bool readTLEandIniSGP4(string satName, string line1, string line2, char opsmode, SGP4unit.Gravconsttype whichconst, SGP4SatData satrec)
        {
            ...
            bool result = SGP4unit.sgp4init(whichconst, opsmode, satrec.satnum,
        ...
        public static string EpochDateString(SGP4SatData satData)
        {
            return string.Format("d/m/y {0}/{1}/{2} JDS={3}",
                satData.day, satData.month, satData.year, satData.jdsatepoch);
        }

        private static bool readLine1(string line1, SGP4SatData satrec)
        {
            ...
            // satnum
            satrec.satnum = (int)ParseFloat(tleLine1.Substring(2, (7 - 2)));
            // classification
            ...
            // epochyr
            satrec.epochyr = (int)ParseFloat(tleLine1.Substring(18, (20 - 18)));

            // epoch days
            satrec.epochdays = ParseFloat(tleLine1.Substring(20, (32 - 20)));

            // ndot
            satrec.ndot = ParseFloat(tleLine1.Substring(33, (43 - 33)));
            ...
            if ((tleLine1.Substring(44, (52 - 44))).Equals("        ")) {
                ...
                satrec.nddot = ParseFloat(tleLine1.Substring(44, (50 - 44))) / 1.0E5;
                //nexp
                satrec.nexp = (int)ParseFloat(tleLine1.Substring(50, (52 - 50)));
            }
            //bstar
            satrec.bstar = ParseFloat(tleLine1.Substring(53, (59 - 53))) / 1.0E5;
            //ibex
            satrec.ibexp = (int)ParseFloat(tleLine1.Substring(59, (61 - 59)));

            // these last things are not essential so just try to read them, and give a warning - but no error
            try {
                // num b.
                satrec.numb = (int)ParseFloat(tleLine1.Substring(62, (63 - 62)));

                //  elnum
                satrec.elnum = (long)ParseFloat(tleLine1.Substring(64, (68 - 64)));
            }
            catch (Exception e) {
        ...
        private static bool readLine2(string line2, SGP4SatData satrec)
        {
            ...
            // satnum
            int satnum = (int)ParseFloat(tleLine2.Substring(2, (7 - 2)));
            if (satnum != satrec.satnum) {
                Debug.Log("Warning TLE line 2 Sat Num doesn't match line1 for sat: " + satrec.name);
            }

            // inclination
            satrec.inclo = ParseFloat(tleLine2.Substring(8, (17 - 8)));

            // nodeo
            satrec.nodeo = ParseFloat(tleLine2.Substring(17, (26 - 17)));

            //satrec.ecco
            satrec.ecco = ParseFloat(tleLine2.Substring(26, (34 - 26))) / 1.0E7;

            // satrec.argpo
            satrec.argpo = ParseFloat(tleLine2.Substring(34, (43 - 34)));

            // satrec.mo (Mean anomoly deg)
            satrec.mo = ParseFloat(tleLine2.Substring(43, (52 - 43)));

            // no (Mean Motion rev/day)
            satrec.no = ParseFloat(tleLine2.Substring(52, (63 - 52)));

            // try to read other data
            try {
                // revnum
                satrec.revnum = (long)ParseFloat(tleLine2.Substring(63, (68 - 63)));
            }
            catch (Exception e) {
         ...
         * @throws Exception 
         */
        protected static double ParseFloat(string inStr)
        {

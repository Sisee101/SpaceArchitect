...
*/
    public class SGP4unit
    {
                 ...
                 double xnodeo, SGP4SatData satrec)
        {
            ...
            //       if(satrec.error == 0)
            bool propOk = sgp4(satrec, 0.0, r, v);  // SEG removed gravity constant passing
                ...
                double[] r, double[] v)
        {
            ...
            if (pl < 0.0) {
                ...
                // PM - track some internal stuff for debug
                // debug of time value for ecentricity
                satrec._el = System.Math.Sqrt(el2);
                satrec._am = am * radiusearthkm; // scale to km
                satrec._mrt = mrt * radiusearthkm; // scale to km
                // based on orientation these seem to be orientation COEs
                satrec._xinc = xinc;
                satrec._xnode = xnode;
                satrec._su = su;
                satrec._argpp = argpp;
        ...
        public static string LogInternalCOE(SGP4SatData satrec)
        {
            return string.Format("am={0}, el={1} su={2} xinc={3} xnode={4} argpp={5}",
                satrec._am, satrec._el, satrec._su, satrec._xinc, satrec._xnode, satrec._argpp);
        }
        ...
        public static double RADIUSEARTHKM = 6378.135;
        ...
        public static double BrowerMeanToTLEMean(SGP4SatData satrec, double aE_km, double incl, double ecc)
        {
            ...
            double n1 = n0 * 1.01;
            double n = SecantRootFind.Secant(A0_rootEquation, n0, n1);
            return n;
        }

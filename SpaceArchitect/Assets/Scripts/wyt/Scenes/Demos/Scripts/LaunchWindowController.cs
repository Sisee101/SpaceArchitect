...
public class LaunchWindowController : MonoBehaviour {
    ...
    private OrbitUniversal[] destinations;
    ...
    void Start () {
        ...
        destinations = (OrbitUniversal[])Object.FindObjectsOfType(typeof(OrbitUniversal));
        FillDropdown();
    ...
    private void FillDropdown() {
        ...
        foreach(OrbitUniversal oe in destinations) {

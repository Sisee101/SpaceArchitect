...
public class KeplerSequenceEditor : Editor {
    ...
    public override void OnInspectorGUI() {
        ...
        if (orbitU != null) {
            ...
            IFixedOrbit fixedO = keplerSeq.GetComponent<IFixedOrbit>();
            if (fixedO == null) {
                Debug.LogWarning("KeplerSequence requires an IFixedOrbit component e.g. OrbitUniversal");
            }
        }
        if (EditorApplication.isPlaying && keplerSeq.gameObject.activeInHierarchy) {
